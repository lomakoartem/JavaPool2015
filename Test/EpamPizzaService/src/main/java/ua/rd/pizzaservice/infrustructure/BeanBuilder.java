...
public class BeanBuilder {
        ...
        private ua.rd.pizzaservice.infrustructure.ApplicationContext applicationContext;
        
        private Object bean;

        public BeanBuilder(Class<?> clazz, ua.rd.pizzaservice.infrustructure.ApplicationContext applicationContext) {
            this.clazz = clazz;
